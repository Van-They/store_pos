...
class CustomerSetUp extends GetView<CustomerController> {
  const CustomerSetUp({super.key});

  static const String routeName = "/CustomerSetUp";

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(
        title: "customer_set_up".tr,
        isBack: true,
      ),
